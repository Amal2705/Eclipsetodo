...
@Test
public void todoebaymousehover() 
{
   ...
   driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	...
	ob.perform();
	waitex.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"mainContent\"]/div[1]/ul/li[3]/div[2]/div[1]/nav[1]/ul/li[1]/a")));
